...
- (void)performLayout {
    ...
    if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
        ...
        UIImage* image= [UIImage imageNamed:@"xiangce-small.png"];
        CGRect backframe= CGRectMake(0, 0, image.size.width, image.size.height-4); 
        ...
        UIBarButtonItem *doneButton=[[UIBarButtonItem alloc] initWithCustomView:backButton];
